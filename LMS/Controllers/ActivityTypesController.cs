...
namespace LMS.Controllers
{
    public class ActivityTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ActivityTypeName")] ActivityType activityType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ActivityTypeName")] ActivityType activityType)
        {
            if (ModelState.IsValid)
            {
